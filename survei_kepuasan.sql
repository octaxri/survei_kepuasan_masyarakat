...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2019 at 08:44 AM
...
INSERT INTO `t_jawaban` (`id`, `jawaban`, `bobot`) VALUES
(1, 'Sangat baik', 5),
(2, 'Baik', 4),
(3, 'Sedang', 3),
(4, 'Buruk', 2),
...
INSERT INTO `t_pertanyaan` (`id`, `pertanyaan`) VALUES
(1, 'Bagaimana pelayanan yang diberikan oleh petugas kami?');
